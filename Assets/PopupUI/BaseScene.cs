...
namespace SVell.PopupUI
{
	public class BaseScene : MonoBehaviour
	{
        ...
        protected Stack<GameObject> _currentPopups = new Stack<GameObject>();
        protected Stack<GameObject> _currentPanels = new Stack<GameObject>();
        ...
        {
            var currentPopup = _currentPopups.Peek();
